...
public class RaymarchCamera1 : SceneViewFilter
{
    ...
    [Header("Signed Distance Field (Mandelbulb)")]
    public Vector4 _mandelbulb;
    public int _mandelbulbIterations;
    public float _mandelbulbBailout;
    public float _mandelbulbPower;
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        _raymarchMaterial.SetVector("_mandelbulb", _mandelbulb);
        _raymarchMaterial.SetInt("_mandelbulbIterations", _mandelbulbIterations);
        _raymarchMaterial.SetFloat("_mandelbulbBailout", _mandelbulbBailout);
        _raymarchMaterial.SetFloat("_mandelbulbPower", _mandelbulbPower);

        // asign colour
        _raymarchMaterial.SetFloat("_ColourIntensity", _ColourIntensity);
        _raymarchMaterial.SetColor("_MainColour", _MainColour);
        // ########################################################################
