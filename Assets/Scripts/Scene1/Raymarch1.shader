Shader "PeerPlay/NewImageEffectShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float _mandelbulbBailout;
            uniform float _mandelbulbPower;
            ...
            {
                float4 mandelbulb = float4(_MainColour.rgb, Mandelbulb((p - _mandelbulb.xyz) / _mandelbulb.w, _mandelbulbIterations, _mandelbulbBailout, _mandelbulbPower) * _mandelbulb.w);
                return mandelbulb;
            }
